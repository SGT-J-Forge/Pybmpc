...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.conv1(x)
        #self.conv1.weight.data = self.conv1.weight.data.sign()
        out = self.bn1(out)
        out = self.relu(out)

        out = self.conv2(out)
        #self.conv2.weight.data = self.conv2.weight.data.sign()
        out = self.bn2(out)
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.conv3(out)
        #self.conv3.weight.data = self.conv3.weight.data.sign()
        out = self.bn3(out)
