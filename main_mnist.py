...
class Net(nn.Module):
    def __init__(self):
        ...
        #self.gn1 = nn.GroupNorm(32,2048*self.infl_ratio)
        ...
        #self.gn2 = nn.GroupNorm(32,2048*self.infl_ratio)
        ...
        #self.gn3 = nn.GroupNorm(32,2048*self.infl_ratio)
...
def train(epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        if epoch % 10 == 0:
            torch.save(model, './test/bi_mnist/bi_mnist.pt')
def test():
    model.eval()
    test_loss = 0
    correct = 0
